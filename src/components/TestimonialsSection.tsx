          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <div className="flex items-center mb-4">
                  <img 
                    src="https://images.unsplash.com/photo-1500000000000?q=80&w=1887&auto=format&fit=crop" 
                    alt="Student 1" 
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <div className="flex items-center mb-4">
                  <img 
                    src="https://images.unsplash.com/photo-1500000000010?q=80&w=1887&auto=format&fit=crop" 
                    alt="Student 2" 
                    className="w-12 h-12 rounded-full object-cover mr-4"
                  />
                  <div>
